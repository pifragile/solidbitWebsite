...
export const caseStudy = {
  ...
  summary: [
    'Encointer is a platform that provides Proof-Of-Personhood technology on the Polkadot blockchain.',
    'We built large parts of the Encointer protocol including the scaling of all core algorithms to be able to process large numbers of transactions and implementing an on-chain democracy module.',
  ],
  logo,
  image: { src: imageHero },
  date: '2023-01',
